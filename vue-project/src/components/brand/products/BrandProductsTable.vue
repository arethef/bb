...
export default {
  ...
  async beforeCreate() {
    ...
    console.log(`❯❯❯❯❯❯ [BrandProductsTable.vue] beforeCreate() allTableProducts:`, allTableProducts);

  },
  methods: {
    async moveBrandProductDetailView(id) {
      console.log(`++++++ [BrandProductsTable.vue] moveBrandProductDetailView() ++++++`);
      console.log(
